...
## 📈 Resultado Visual
O gráfico final foi estilizado utilizando a paleta `mako` do Seaborn, com rótulos de dados dinâmicos formatados em moeda formatados diretamente via código:
...
* **Visualização Avançada (Matplotlib + Seaborn):** Criação de um gráfico de barras moderno com laço de repetição (`for`) automatizado para inserção dos rótulos de dados nos eixos corretos.
